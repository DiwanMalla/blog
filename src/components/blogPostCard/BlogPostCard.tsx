            ...
            rounded-xl overflow-hidden`}
              >
                ...
                <div className="p-6">
                  ...
                  {/*Blog Description*/}
                  <p
                    className="loading-relaxed mb-3"
                    style={{
                      color:
                        mode === "dark" ? "rgb(226,232,240)" : "rgb(30,41,59",
                    }}
                  >
                    This is my first blog of my blogging website developed by
                    Diwan with the help of Devknus.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 md:w-1/3">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/*Blog Title*/}
                  <h1
                    className="text-lg font-bold title-font text-gray- mb-3"
                    style={{
                      color:
                        mode === "dark" ? "rgb(226,232,240)" : "rgb(30,41,59)",
                    }}
